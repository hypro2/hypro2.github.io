...
12.  사용자 피드백을 수집하면 모델을 개선하고 사용자 요구를 파악할 수 있습니다. 사용자의 선호도와 의견은 모델의 향후 개선과 평가에 도움이 되며, 명시적 또는 암시적인 피드백을 통해 수집할 수 있습니다. 이를 통해 모델을 개선하고 사용자에게 더 나은 서비스를 제공할 수 있습니다.
13.  Evals (평가)
